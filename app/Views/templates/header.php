        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="sidebar">
            ...
            <?php if (isset($_SESSION['is_admin']) && $_SESSION['is_admin']): ?>
                ...
                <li class="nav-item <?= isActive('admin/categorias', $current_path) ? 'active' : '' ?>">
                    ...
                    <a class="nav-link" href="<?= $baseUrl ?>admin/categorias"> <i class="fas fa-fw fa-tags"></i> <span>Categorias</span></a>

                </li>

                <li class="nav-item <?= isActive($baseUrl . 'admin/situacoes', $current_path) ? 'active' : '' ?>">

                    <a class="nav-link" href="<?= $baseUrl ?>admin/situacoes"> <i class="fas fa-fw fa-check-circle"></i> <span>Situações</span></a>

                </li>

                <li class="nav-item <?= isActive($baseUrl . 'admin/formas-de-pagamento', $current_path) ? 'active' : '' ?>">

                    <a class="nav-link" href="<?= $baseUrl ?>admin/formas-de-pagamento"> <i class="fas fa-fw fa-credit-card"></i> <span>Formas Pag.</span></a>

                </li>

                <li class="nav-item <?= isActive($baseUrl . 'admin/usuarios', $current_path) ? 'active' : '' ?>">

                    <a class="nav-link" href="<?= $baseUrl ?>admin/usuarios"> <i class="fas fa-fw fa-users"></i> <span>Usuários</span></a>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">
                                    ...
                                    <?php echo isset($_SESSION['user_name']) ? esc($_SESSION['user_name']) : 'Usuário'; ?>
