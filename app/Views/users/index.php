<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="/usuarios/create" class="btn btn-primary shadow-sm">
            ...
            <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        ...
                        <th>Username</th>
                        <th>Email</th> <th style="width: 10%;">Status</th>
                    ...
                    <?php if (!empty($users_list) && is_array($users_list)): ?>
                        <?php foreach ($users_list as $user): ?>
                            <tr>
                                ...
                                <td><?= esc($user->email ?? 'N/A') // Use ->email ou ->getIdentities()[0]['secret'] dependendo de como buscar ?></td>
                                <td>
                                ...
                                <td>
                                    <a href="/usuarios/edit/<?= esc($user->id) ?>" class="btn btn-sm btn-info" title="Editar Usuário">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="/usuarios/groups/<?= esc($user->id) ?>" class="btn btn-sm btn-secondary" title="Gerenciar Grupos">
                                        <i class="fas fa-users-cog"></i>
                                    </a>
                                    <a href="/usuarios/delete/<?= esc($user->id) ?>" class="btn btn-sm btn-danger" title="Excluir Usuário" onclick="return confirm('Tem certeza que deseja excluir este usuário? Esta ação é irreversível!');">
